  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <Card className="bg-white border-gray-200 shadow-xl rounded-2xl overflow-hidden">
        <CardHeader className="text-center pb-6 pt-8 px-8">
          ...
          <CardDescription className="text-gray-600 mt-2">
            Join NeighborFit to find your perfect Indian neighborhood
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="px-8 pb-8">
          <form action={formAction} className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link href="/auth/login" className="text-airbnb-500 hover:text-airbnb-600 font-medium hover:underline">
                Sign in
              </Link>
            </div>
          </form>
      ...
      <div className="mt-6 text-center text-xs text-gray-500">
        ...
        <a href="#" className="text-airbnb-500 hover:underline">
          Terms of Service
        </a>{" "}
        and{" "}
        <a href="#" className="text-airbnb-500 hover:underline">
